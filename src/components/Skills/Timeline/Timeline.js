      ...
      <div className={styles.timeline}>
        <div className={styles.containerRight}>
          <div className={styles.content}>
            ...
            <p>Current Projects Head @ IEEE Computer Society VIT, a technical Student Branch dedicated to the Open Source philosophy of its parent organization.</p>
          </div>
        </div>
        <div className={styles.containerLeft}>
          <div className={styles.content}>
            ...
            <p>Developed multiple frontend views for Apli.ai, an IIT-B Based campus recruitment startup. Most commonly working with Bootstrap and JQuery.</p>
          </div>
        </div>
        <div className={styles.containerRight}>
          <div className={styles.content}>
            ...
            <p>Former Radio Jockey @ VIT Radio 90.8MHz. Hosted 2 shows and mentored junior RJs for the same. </p>
          </div>
        </div>
        <div className={styles.containerLeft}>
          <div className={styles.content}>
            ...
            <p>Part of the team tasked with redesigning and redeveloping a revised website for Surya NestBuild Ltd., a construction firm based in Patna, Bihar.</p>
          </div>
        </div>
      </div>
